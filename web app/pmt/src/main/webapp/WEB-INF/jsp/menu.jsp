...
<div class="container">
	...
	<br>
	<label>
		<a href="/modifygroup" class="btn btn-warning btn-lg">Modify Group</a>
	</label>
	
	<br>
	<br>
	<label>
		<a href="/modifyurl" class="btn btn-warning btn-lg">Modify URL</a>
	</label>
	<br>
	<br>
	<label>
		<a href="/read" class="btn btn-success btn-lg">Read Password</a>
	</label>
	<br>
	<br>
	
	<label>
		<a href="/update" class="btn btn-warning btn-lg">Modify Password</a>
	</label>
	<br>
	<br>
	<label>
